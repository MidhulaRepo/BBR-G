...
class TcpSocketBase : public TcpSocket
{
  ...
  private:                                                                    //Added by Midhula on April 2, 2024
    uint32_t m_totalRetransmissions; // Counter for total retransmissions
  ...
  public:
    ...
    uint32_t GetDupAckCount() const;  //by midhula for accessing from tcp-bbr.cc
