...
class TcpBbr : public TcpCongestionOps
{
  ...
  private:
   ...
   //Time m_currRtt;        //by midhula for tcp bbr.cc
  // Time m_prevRtt;
  // Time m_sumRtt;
  // Time m_minRtt;
  // Time m_avgRtt;        //by midhula for tcp bbr.cc
   // uint32_t m_dupAckCount{0};   //by midhula
  //  uint64_t m_countPacket;     //by midhula from tcp-bb.cc
 //   double m_rttFactor;  //by midhula from tcp-bb.cc
   // double m_xFactor;    //by midhula from tcp-bb.cc
  //  double m_maxQueueLength{0}; // Midhula Oct 20
    //uint32_t duplicateAckCount{0}; //midhula Oct 20
