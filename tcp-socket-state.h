...
class TcpSocketState : public Object
{
  public:
    ...
    double min_rttf{(0.0)};
    double m_result{(0.0)};
    double m_result1{(0.0)};
    double m_rttrate{(0.0)};
    double m_sum{(0.0)};
    double decre{(0.0)};
    uint32_t m_lastSeqNum{0} ;
    uint32_t m_nextAckNumber{0};
    uint32_t m_send_pnum{0};
    uint32_t m_recv_pnum{0};
    uint32_t m_currentloss_pnum{0};
    uint32_t m_previousloss_pnum{0};
